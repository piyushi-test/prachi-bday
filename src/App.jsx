    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">[Meri Rasmalai]</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">[Rasmalai]'s</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>Maybe This can bring smile on your face  💗</p>
        </section>
      ...
      >
        ...
        <button className="page-nav-btn" onClick={() => goToPage(4)}>
          📸 These are the pictures i adore alot 
        </button>
      </div>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 I'll always be your side no matter what — [Rahul] 💖</h2>
          <p className="final-subtitle">Shayad tumhare liye jyada hogya hoga but merre liye to jitna me de skta hu uska ye half bhi nahi, I hope tumhara ye bday bhot special rahe Lots Of Love To You 💕 ✨</p>
        </section>
      </div>
